...
PRODUCTS = [
  {
    ...
    price_cents: 4400, size: "20 кг", categories: %w[carwash], featured: true,
  ...
  },
  {
    ...
    price_cents: 4700, size: "20 кг", categories: %w[carwash],
  ...
  },
  {
    ...
    price_cents: 4800, size: "5 кг", categories: %w[carwash], best_seller: true,
  ...
  },
  {
    ...
    price_cents: 1700, size: "5 кг", categories: %w[carwash],
  ...
  },
  {
    ...
    price_cents: 4100, size: "5 кг", categories: %w[carwash], best_seller: true,
  ...
  },
  {
    ...
    price_cents: 4800, size: "5 кг", categories: %w[carwash],
  ...
  },
  {
    ...
    price_cents: 3200, size: "5 кг", categories: %w[carwash], best_seller: true,
  ...
  },
  {
    ...
    price_cents: 11000, size: "20 кг", categories: %w[carpet-washing], featured: true,
  ...
  },
  {
    ...
    price_cents: 10500, size: "20 кг", categories: %w[carpet-washing], featured: true,
  ...
  },
  {
    ...
    price_cents: 15500, size: "20 кг", categories: %w[carpet-washing], best_seller: true,
  ...
  },
  {
    ...
    price_cents: 750, size: "1 L", categories: %w[carwash other carpet-washing], best_seller: true,
